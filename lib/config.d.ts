 ...
 */
export declare const OPENSERP_BASE_URL_ENV = "OPENSERP_URL";
/**
 ...
 */
export declare const OPENSERP_SETTINGS_NAMESPACE = "web-search-openserp";
/**
 ...
 */
export declare function resolveBaseURL(config: Config): {
 ...
 */
export declare function resolveOptions(config: Config): OpenserpSearchProviderOptions;
/**
 ...
 */
export declare function resolveFetchOptions(config: Config): OpenserpFetchProviderOptions;
